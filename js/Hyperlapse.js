...
var Hyperlapse = function(container, params) {
	...
	var self = this,
		...
		_params = params || {},
		_w = _params.width || 800*1.5,
		_h = _params.height || 400*1.5,
		_d = 20,
		...
		_canvas, _context,
		_camera, _scene, _mesh, //_renderer,
	...
	_renderer.domElement.id = 'innerPano';
...
var hyperlapse = new Hyperlapse(document.getElementById('pano'), {
	lookat: new google.maps.LatLng(40.692207,-73.968641),
	zoom: 1,
	use_lookat: true,
	elevation: 50
});
...
var route = {
	request:{
		origin: new google.maps.LatLng(40.692207,-73.968641),
		destination: new google.maps.LatLng(40.691019,-73.996621),
